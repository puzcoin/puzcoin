...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Puzcoin Core puzcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  puzcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded puzcoin transaction") + "\n" +
              "  puzcoin-tx [options] -create [commands]   " + _("Create hex-encoded puzcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded puzcoin transaction
