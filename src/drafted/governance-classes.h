 ...
 *
 *   // network
 *   CPuzcoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.puzcoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CPuzcoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CPuzcoinNetwork(UniValue objIn)
    {
...
// // can be under: PuzcoinNetwork
// //   -- signature requirements : Key1(User)
// class CPuzcoinNetworkVariable : public CGovernanceObject
// {
// private:
