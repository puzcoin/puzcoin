...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "PuzcoinNetwork") type = PuzcoinNetwork;
    if(strType == "PuzcoinNetworkVariable") type = PuzcoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == PuzcoinNetwork) s = "PuzcoinNetwork";
    if(type == PuzcoinNetworkVariable) s = "PuzcoinNetworkVariable";
