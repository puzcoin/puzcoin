...
#define PACKAGE_BUGREPORT "https://github.com/puzcoin/puzcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Puzcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Puzcoin Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "puzcoincore"
