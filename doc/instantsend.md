...
This mechanism has been integrated into Bitcore-Node-Puzcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/puzcoinpay/insight-api-puzcoin#web-socket-api](https://github.com/puzcoinpay/insight-api-puzcoin#web-socket-api) 
* API: [https://github.com/puzcoinpay/insight-api-puzcoin#instantsend-transactions](https://github.com/puzcoinpay/insight-api-puzcoin#instantsend-transactions) 
...
By default, the Puzcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Puzcoin Core daemon:
