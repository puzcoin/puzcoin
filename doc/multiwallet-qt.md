...
Only requiring some minor changes is puzcoin.cpp.
...
Changes to puzcoin.cpp
----------------------
puzcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
