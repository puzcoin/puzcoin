...
Puzcoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Puzcoin Core, where everyone uses
...
pay attention to for reviewers of Puzcoin Core code.

General Puzcoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Puzcoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
